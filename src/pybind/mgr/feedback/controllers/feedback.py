...
from ...dashboard.rest_client import RequestException
from ...dashboard.security import Scope
from ..services.feedback import CephTrackerClient
from ...dashboard.controllers import ApiController, ControllerDoc, RESTController
...
class FeedbackController(RESTController):
    ...
    def __init__(self):  # pragma: no cover
        ...
        self.tracker_client = CephTrackerClient()
