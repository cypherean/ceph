...
# class FeedbackTest(ControllerTestCase, KVStoreMockMixin):
#     @classmethod
#     def setup_server(cls):
#         # pylint: disable=protected-access
#         cls.setup_controllers([Feedback])
...
#             Settings.CEPH_TRACKER_API_KEY = apiKey

#     def test_get_issues(self, issue_number):
#         self.server_settings()
#         self._get('/api/feedback/{issue_number}')
